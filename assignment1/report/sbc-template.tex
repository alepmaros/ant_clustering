...
O agrupamento baseado em formigas (Ant-clustering) é uma técnica de agrupamento bioinspirada baseado
...
na posição extrema esquerda, como se o tabuleiro fosse na verdade um globo.
...
aleatórios baseados no tempo em que está sendo executado o experimento. Com raio 1
foram realizados 11 agrupamentos, com raio 5 foi observado 4 agrupamentos e com raio 10
surgiram também 4 agrupamentos. 

\begin{figure}[ht]
\centering
\includegraphics[width=.51\textwidth]{figuras/ants_random1.png}
\caption{Agrupamento de formigas com a sementes diferentes.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.51\textwidth]{figuras/ants_seed1.png}
\caption{Agrupamento de formigas com a mesma semente.}
\label{fig:ant_seed1}
\end{figure}
...
como o raio afeta o agrupamento dado uma mesma configuração inicial. As formigas com
raio 1 realizaram 9 agrupamentos, com raio 5 houve 5 agrupamentos e com raio 10 houve
4 agrupamentos.

É possível observar que quanto maior o raio menos grupos com mais formigas foram formadas,
entretanto, mais formigas "soltas", isto é, fora de um grupo são observadas. Outro fator
de desempenho observado é o tempo. O primeiro valor de cada quadrante das
...
\begin{tabular}{|p{4cm}||p{4cm}|p{4cm}|}
 ...
 \hline
 Raio 1  & 74.038s       & 75.200s       \\%&              \\
 Raio 5  & 377.851s      & 381.403s      \\%&              \\
 Raio 10 & 1331.510s     & 1286.260s     \\%&              \\
 \hline
\end{tabular}
