...
P_{c} = 
    \begin{cases}
        \biggl(\dfrac{n_{vazios}}{n_{total}}\biggr)^2 \times 100, & \text{if } n_{vazios} \neq n_{total} \\
        99, & \text{if } n_{vazios} = n_{total} \\
        1, & \text{if } n_{vazios} = 0
    \end{cases}
\end{equation}
...
P_{s} =
    \begin{cases}
        \biggl( \dfrac{n_{mortas}}{n_{total}} \biggr)^2 \times 100,& \text{if } n_{mortas} \neq  n_{total} \\
        99, & \text{if } n_{mortas} = n_{total} \\
        1, & \text{if } n_{mortas} = 0
    \end{cases}
\end{equation}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.7\textwidth]{figuras/ants_seed1.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.7\textwidth]{figuras/ants_random1.png}
